...
from models.rankae import RankAE as AbsSummarizer
from models.predictor import build_predictor
from models.rankae_trainer import build_trainer
...
def validate(args, device_id):
    ...
    if (args.test_all):
        ...
        for i, cp in enumerate(cp_files):
            ...
            if rouge_dev[0] > best_dev_results[0] and rouge_dev[1] > best_dev_results[1]:
